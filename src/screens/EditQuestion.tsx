...
const EditQuestion = ({navigation, route}) => {
  ...
  const validate = () => {
    ...
    if (questionInfo.correctAnswer == '0') {
  ...
  const saveQuestion = async () => {
    if (validate()) {
      await databaseService.updateQuestion(questionInfo);
      navigation.goBack();
    }
  };

  const deleteQuestion = async () => {
    await databaseService.deleteQuestion(questionInfo.id);
    navigation.goBack();
  };
      ...
      <View>
        <View style={styles.con0}>
          <View style={styles.con1}>
            ...
            <Text style={styles.addUserText}>Edit Question</Text>
          </View>
        ...
        <View style={styles.con2}>
          <Picker
            ...
            <Picker.Item label="Select Correct Answer" value="0" />
